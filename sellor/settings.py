...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://sellor:sellor@localhost:5432/sellor',
        conn_max_age=600)}
...
if DEBUG:
    ...
    EMAIL_HOST_USER = 'sellorapp@gmail.com'
    EMAIL_HOST_PASSWORD = 'Q0W3E0R4'
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
    DEFAULT_FROM_EMAIL = 'noreply@sellor.co'
...
STATICFILES_DIRS = [
    ('assets', os.path.join(PROJECT_ROOT, 'sellor', 'static', 'assets')),
    ('favicons', os.path.join(PROJECT_ROOT, 'sellor', 'static', 'favicons')),
    ('images', os.path.join(PROJECT_ROOT, 'sellor', 'static', 'images')),
    ('dashboard/images', os.path.join(
        PROJECT_ROOT, 'sellor', 'static', 'dashboard', 'images'))]
STATICFILES_FINDERS = [
...
context_processors = [
    ...
    'sellor.core.context_processors.default_currency',
    'sellor.checkout.context_processors.cart_counter',
    'sellor.core.context_processors.search_enabled',
    'sellor.site.context_processors.site',
...
SECRET_KEY = '=_a-sk=%j@324e+qab0(_u1%p)2%8p#+45kq6cnk#r+(vk(0ah'
...
MIDDLEWARE = [
    ...
    'sellor.core.middleware.discounts',
    'sellor.core.middleware.google_analytics',
    'sellor.core.middleware.country',
    'sellor.core.middleware.currency',
    'sellor.core.middleware.site',
    'sellor.core.middleware.taxes',
    'social_django.middleware.SocialAuthExceptionMiddleware',
    'impersonate.middleware.ImpersonateMiddleware',
    'sellor.graphql.middleware.jwt_middleware'
]
...
bootstrap4 = {
    ...
    'success_css_class': '',
    'form_renderers': {
        'default': 'sellor.core.utils.form_renderer.FormRenderer'}}
...
if AWS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = 'sellor.core.storages.S3MediaStorage'
...
if ES_URL:
    SEARCH_BACKEND = 'sellor.search.backends.elasticsearch'
...
AUTHENTICATION_BACKENDS = [
    'sellor.account.backends.facebook.CustomFacebookOAuth2',
    'sellor.account.backends.google.CustomGoogleOAuth2',
...
IMPERSONATE = {
    ...
    'CUSTOM_USER_QUERYSET': 'sellor.account.impersonate.get_impersonatable_users',  # noqa
    'USE_HTTP_REFERER': True,
    'CUSTOM_ALLOW': 'sellor.account.impersonate.can_impersonate'}
...
SERIALIZATION_MODULES = {
    'json': 'sellor.core.utils.json_serializer'}
...
PAYMENT_GATEWAYS = {
    DUMMY: {
        'module': 'sellor.payment.gateways.dummy',
        'connection_params': {}},
    BRAINTREE: {
    ...
    RAZORPAY: {
        'module': 'sellor.payment.gateways.razorpay',
        'connection_params': {
    ...
    STRIPE: {
        'module': 'sellor.payment.gateways.stripe',
        'connection_params': {
            'public_key': os.environ.get('STRIPE_PUBLIC_KEY'),
            'secret_key': os.environ.get('STRIPE_SECRET_KEY'),
            'store_name': os.environ.get(
                'STRIPE_STORE_NAME', 'sellor'),
