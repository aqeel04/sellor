    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error', models.CharField(choices=[(sellor.payment.TransactionError('incorrect_number'), 'incorrect_number'), (sellor.payment.TransactionError('invalid_number'), 'invalid_number'), (sellor.payment.TransactionError('incorrect_cvv'), 'incorrect_cvv'), (sellor.payment.TransactionError('invalid_cvv'), 'invalid_cvv'), (sellor.payment.TransactionError('incorrect_zip'), 'incorrect_zip'), (sellor.payment.TransactionError('incorrect_address'), 'incorrect_address'), (sellor.payment.TransactionError('invalid_expiry_date'), 'invalid_expiry_date'), (sellor.payment.TransactionError('expired'), 'expired'), (sellor.payment.TransactionError('processing_error'), 'processing_error'), (sellor.payment.TransactionError('declined'), 'declined')], max_length=256, null=True)),
                ('currency', models.CharField(max_length=10)),
