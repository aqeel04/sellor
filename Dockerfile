...
# Build static
COPY ./sellor/static /app/sellor/static/
...
RUN groupadd -r sellor && useradd -r -g sellor sellor
...
COPY --from=build-nodejs /app/sellor/static /app/sellor/static
...
CMD ["uwsgi", "--ini", "/app/sellor/wsgi/uwsgi.ini"]
