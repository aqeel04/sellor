...
from sellor.data_feeds.google_merchant import (
    get_feed_items, item_attributes, item_google_product_category, write_feed)
from sellor.product.models import AttributeValue, Category


def test_sellor_feed_items(product, site_settings):
...
@patch('sellor.data_feeds.google_merchant.item_link')
