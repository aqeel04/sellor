...
from sellor.product.templatetags.product_images import (
...
def test_get_thumbnail_no_instance(monkeypatch):
    monkeypatch.setattr(
        'sellor.product.templatetags.product_images.choose_placeholder',
...
@patch(
    'sellor.product.templatetags.product_images.AVAILABLE_SIZES',
    {'products': (
