...
from sellor.payment.gateways.braintree import (
    ...
    refund, void)
from sellor.payment.gateways.braintree.errors import (
    DEFAULT_ERROR_MESSAGE, BraintreeException)
from sellor.payment.gateways.braintree.forms import BraintreePaymentForm
from sellor.payment.utils import create_payment_information
...
def test_get_error_for_client(braintree_error, monkeypatch):
    ...
    monkeypatch.setattr(
        'sellor.payment.gateways.braintree.ERROR_CODES_WHITELIST', {})
...
@patch('sellor.payment.gateways.braintree.get_braintree_gateway')
