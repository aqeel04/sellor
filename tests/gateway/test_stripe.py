...
from sellor.payment.gateways.stripe import (
...
from sellor.payment.gateways.stripe.errors import (
    ORDER_NOT_AUTHORIZED, ORDER_NOT_CHARGED)
from sellor.payment.gateways.stripe.forms import (
    StripeCheckoutWidget, StripePaymentModalForm)
from sellor.payment.gateways.stripe.utils import (
...
def test_widget_with_default_options(stripe_payment, gateway_params):
    ...
    assert widget.render() == (
        ...
        'data-name="sellor" data-shipping-address="false" '
