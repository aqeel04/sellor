...
from sellor.account.backends import BaseBackend
from sellor.account.models import Address, User
from sellor.checkout import utils
from sellor.checkout.models import Cart
from sellor.checkout.utils import add_variant_to_cart
from sellor.dashboard.menu.utils import update_menu
from sellor.dashboard.order.utils import fulfill_order_line
from sellor.discount import VoucherType
from sellor.discount.models import Sale, Voucher, VoucherTranslation
from sellor.menu.models import Menu, MenuItem
from sellor.order import OrderEvents, OrderStatus
from sellor.order.models import FulfillmentStatus, Order, OrderEvent
from sellor.order.utils import recalculate_order
from sellor.page.models import Page
from sellor.payment import ChargeStatus, TransactionKind
from sellor.payment.models import Payment
from sellor.product.models import (
...
from sellor.shipping.models import (
    ShippingMethod, ShippingMethodType, ShippingZone)
from sellor.site import AuthenticationBackends
from sellor.site.models import AuthorizationKey, SiteSettings
...
def site_settings(db, settings):
    ...
    sellor.site.models.SiteSettings have a one-to-one relationship and a site
