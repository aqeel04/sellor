...
from sellor.order import OrderEvents, OrderEventsEmails
from sellor.order.views import PAYMENT_TEMPLATE
from sellor.payment import (
    ChargeStatus, GatewayError, OperationType, PaymentError, TransactionKind,
    get_payment_gateway)
from sellor.payment.models import Payment
from sellor.payment.utils import (
...
@patch('sellor.payment.utils.get_payment_gateway')
...
@patch('sellor.payment.utils.handle_fully_paid_order')
@patch('sellor.payment.utils.get_payment_gateway')
