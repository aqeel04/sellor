...
from sellor.account import forms, i18n
from sellor.account.forms import FormWithReCaptcha, NameForm
from sellor.account.models import User
from sellor.account.templatetags.i18n_address_tags import format_address
from sellor.account.utils import get_user_first_name, get_user_last_name
from sellor.account.validators import validate_possible_number
...
@patch('sellor.account.views.send_account_delete_confirmation_email.delay')
