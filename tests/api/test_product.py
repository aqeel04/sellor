...
from sellor.graphql.product.enums import StockAvailability
from sellor.graphql.product.types import resolve_attribute_list
from sellor.product.models import (
    Attribute, AttributeValue, Category, Product, ProductImage, ProductType,
    ProductVariant)
from sellor.product.tasks import update_variants_names
...
def test_product_query(staff_api_client, product, permission_manage_products):
    ...
    from sellor.product.utils.costs import get_product_costs_data
...
def test_product_image_create_mutation(
    ...
    monkeypatch.setattr(
        ('sellor.graphql.product.mutations.products.'
...
@patch('sellor.product.tasks.update_variants_names.delay')
...
@patch('sellor.product.tasks._update_variants_names')
