...
from sellor.graphql.middleware import jwt_middleware
from sellor.graphql.product.types import Product
from sellor.graphql.utils import (
...
@patch('sellor.product.models.Product.objects')
