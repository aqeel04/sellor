...
from sellor.graphql.core.enums import ReportingPeriod
from sellor.graphql.order.enums import OrderEventsEmailsEnum, OrderStatusFilter
from sellor.graphql.order.mutations.orders import (
    clean_order_cancel, clean_order_capture, clean_refund_payment,
    clean_void_payment)
from sellor.graphql.order.utils import can_finalize_draft_order
from sellor.graphql.payment.types import PaymentChargeStatusEnum
from sellor.order import OrderEvents, OrderEventsEmails, OrderStatus
from sellor.order.models import Order, OrderEvent
from sellor.payment import ChargeStatus, CustomPaymentChoices
from sellor.payment.models import Payment
from sellor.shipping.models import ShippingMethod
...
def test_clean_order_void_payment():
    ...
    with patch('sellor.graphql.order.mutations.orders.gateway_void',
