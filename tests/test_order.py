...
from sellor.checkout.utils import create_order
...
from sellor.core.weight import zero_weight
from sellor.order import FulfillmentStatus, OrderStatus, models
from sellor.order.models import Order
from sellor.order.utils import (
...
from sellor.payment import ChargeStatus
