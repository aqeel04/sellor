...
from sellor.menu.models import MenuItemTranslation
from sellor.product import ProductAvailabilityStatus, models
from sellor.product.thumbnails import create_product_thumbnails
from sellor.product.utils import (
    allocate_stock, deallocate_stock, decrease_stock, increase_stock)
from sellor.product.utils.attributes import get_product_attributes_data
from sellor.product.utils.availability import get_product_availability_status
from sellor.product.utils.variants_picker import get_variant_picker_data
...
@patch('sellor.product.thumbnails.create_thumbnails')
