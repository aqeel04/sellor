...
from sellor.core.utils import format_money
from sellor.core.utils.taxes import get_taxed_shipping_price
...
def test_shipping_get_total(monkeypatch, shipping_zone, vatlayer):
    ...
    monkeypatch.setattr(
        'sellor.shipping.models.get_taxed_shipping_price', mock_get_price)
