...
from sellor.core.storages import S3MediaStorage
from sellor.core.utils import (
...
from sellor.core.utils.text import get_cleaner, strip_html
from sellor.core.weight import WeightUnits, convert_weight
from sellor.discount.models import Sale, Voucher
from sellor.order.models import Order
from sellor.product.models import ProductImage
...
def test_get_country_by_ip(ip_data, expected_country, monkeypatch):
    monkeypatch.setattr(
        'sellor.core.utils.georeader.get',
...
def test_create_fake_order(db, monkeypatch, image):
    ...
    monkeypatch.setattr(
        'sellor.core.utils.random_data.get_image',
