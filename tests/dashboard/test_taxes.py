...
from sellor.core.utils import get_country_name_by_code
from sellor.core.utils.taxes import (
    apply_tax_to_price, get_taxes_for_address, get_taxes_for_country)
from sellor.dashboard.taxes.filters import get_country_choices_for_vat
...
@mock.patch('sellor.dashboard.taxes.views.messages', create=True)
@mock.patch('sellor.dashboard.taxes.views.call_command', create=True)
...
@mock.patch('sellor.dashboard.taxes.views.messages', create=True)
@mock.patch('sellor.dashboard.taxes.views.logger', create=True)
@mock.patch(
    'sellor.dashboard.taxes.views.call_command',
