...
from sellor.dashboard.page.forms import PageForm
...
@mock.patch('sellor.dashboard.page.views.get_menus_that_needs_update')
@mock.patch('sellor.dashboard.page.views.update_menus')
