...
from sellor.dashboard.collection.forms import CollectionForm
from sellor.product.models import Collection
...
def test_collection_create_view(monkeypatch, admin_client):
    ...
    monkeypatch.setattr(
        ('sellor.dashboard.collection.forms.'
...
@mock.patch('sellor.dashboard.collection.views.get_menus_that_needs_update')
@mock.patch('sellor.dashboard.collection.views.update_menus')
