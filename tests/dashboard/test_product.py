...
from sellor.dashboard.product import ProductBulkAction
from sellor.dashboard.product.forms import ProductForm, ProductVariantForm
from sellor.product.forms import VariantChoiceField
...
def test_view_product_image_create(
    ...
    monkeypatch.setattr(
        'sellor.dashboard.product.forms.create_product_thumbnails.delay',
