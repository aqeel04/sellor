...
from sellor.core.utils import build_absolute_uri
from sellor.dashboard.staff.forms import StaffForm
from sellor.dashboard.staff.utils import remove_staff_member
from sellor.settings import DEFAULT_FROM_EMAIL
