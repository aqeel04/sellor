...
from sellor.dashboard.templatetags.chips import (
...
from sellor.dashboard.widgets import MoneyRangeWidget
from sellor.product.models import Category, Product
